...
public class TripleSDES {
	...
	public static void main(String args[]){
		...
		byte[] key1 = SDEScracker.stringToByteArray("1111111111");
		byte[] key2 = SDEScracker.stringToByteArray("1111111111");
		byte[] plaintext =  SDEScracker.stringToByteArray("10101010");
